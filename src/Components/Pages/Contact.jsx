            ...
            <div className='main m-10 fade-in fade-in-delay-4'>
                <div className='w-full bg-indigo-500 p-10 rounded-3xl shadow-xl'>
                    <div className='flex flex-col'>
                        ...
                        <input type="text" placeholder='Email Address' className='bg-gray-200 outline-none p-2' /> <br />
                        <textarea name="messae" placeholder='Type your Message' className=' bg-gray-200 p-2 outline-none '></textarea> <br />
                        <button
